                ...
                await supabase
                    ...
                    .then(async res => {
                        ...
                        if (data && statusText === "OK") {
                            ...
                            const lo2_mediaFile = fs.readFileSync(
                                lo2_media.path
                            );
                            ...
                            const lo3_mediaFile = fs.readFileSync(
                                lo3_media.path
                            );
                            ...
                            // Get Public URL
                            const lo1_media_URL =
                                bucket.getPublicUrl(lo1_media_name);
                            const lo2_media_URL =
                                bucket.getPublicUrl(lo2_media_name);
                            const lo3_media_URL =
                                bucket.getPublicUrl(lo3_media_name);
