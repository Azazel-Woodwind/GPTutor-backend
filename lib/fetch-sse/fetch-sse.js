...
var globalFetch = require("./fetch").fetch;
var streamAsyncIterable =
    require("./stream-async-iterable").streamAsyncIterable;
function fetchSSE(url, options, fetch) {
    if (fetch === void 0) {
        fetch = globalFetch;
    }
    var e_1, _a;
            ...
            switch (_d.label) {
                case 0:
                    (onMessage = options.onMessage),
                        (fetchOptions = __rest(options, ["onMessage"]));
                ...
                case 4:
                    ...
                    return [3 /*break*/, 5];
                case 5:
                    msg = "ChatGPT error " + res.status + ": " + reason;
                ...
                case 7:
                    ...
                    _b = __asyncValues(streamAsyncIterable(res.body));
                    _d.label = 8;
                case 8:
                    return [4 /*yield*/, _b.next()];
                case 9:
                    if (!((_c = _d.sent()), !_c.done)) return [3 /*break*/, 11];
                    chunk = _c.value;
